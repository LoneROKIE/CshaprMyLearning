...
namespace EPM
{
    public class EmpleadoBaseMasComision3 : EmpleadoPorComision2 // hereda de EmpleadoPorComision
    {
        ...
        public EmpleadoBaseMasComision3(string nombre, string apellido, string nss, decimal ventas, decimal tarifa,
