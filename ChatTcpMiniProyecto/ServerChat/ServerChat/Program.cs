...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            Socket clientSocket = serverSocket.Accept(); // acepta peticiones
            ...
            string newClientMessage = string.Format("{0} has joined to the chat!", username);
    ...
    static void ReceiveMessage(Socket clientSocket)
    {
        while (true)
        {
            ...
            try
            {
                ...
                {
                    // if the client socket is closed, remove the client from the dictionary and
